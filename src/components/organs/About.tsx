                ...
                <div className="h-full w-full md:order-1 order-2 flex flex-col justify-center items-start gap-4 pb-8 md:pb-12">
                    <Fade>
                        <div className="flex flex-col mt-10 items-start relative before:absolute before:-bottom-6 before:left-0 before:w-20 before:h-1 before:rounded-lg before:bg-gradient-to-r before:from-amber-500 before:to-red-500 z-10">
                            <Text as="p" className="text-amber-500 lg:text-sm text-xs tracking-widest uppercase font-medium">{t('AboutTexts.firstText')}</Text>
                            <Text as="h1" className="text-zinc-100 lg:text-5xl md:text-4xl text-3xl">{t('AboutTexts.secondText')}</Text>
                            ...
                            Fade</div>
                        <Text as="h2" className="text-zinc-200 mt-10 mb-4 text-lg">{t('AboutTexts.caption')}</Text>
                        <Text as="p" className="text-zinc-400 text-justify text-base">{t('AboutTexts.paragraph1')}</Text>
                    </Fade>
                </div>
